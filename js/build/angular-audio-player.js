...
.directive('audioPlayer', ['$rootScope', '$log', '$interpolate', '$timeout', 'throttle',
  function ($rootScope, $log, $interpolate, $timeout, throttle) {
    ...
    angular.extend(this, {
       ...
       //download properties
        downloadBtnLabel:DownloadAudioList.setFlagForCheckValue,
        downloadRemaingPercent:0,
  ...
  download: function (fileUrl) {
   if(DownloadAudioList.setFlagForCheckValue == 1)
  {  var dis = this;
     var r=confirm("Delete Local MP3!");
     if (r==true)
    {
     DownloadAudioList.deleteAudioFile(function(value){
          alert("Delete Local MP3! Successfully");
          DownloadAudioList.setFlagForCheckValue = 2;
         },function(value){
       },fileUrl);
    }
 } 
  ...
  {
     if(DownloadAudioList.setFlagForCheckValue == 3)
     {
       alert("Please Wait MP3! Downloading .....");
     }
     else
     {
      DownloadAudioList.startDownlaodAudioFile(function(value){
         alert("Start Local MP3! Downloading");
         DownloadAudioList.setFlagForCheckValue = 3;
         },function(value){
           DownloadAudioList.setFlagForCheckValue = 2;
         },fileUrl);
       } 
